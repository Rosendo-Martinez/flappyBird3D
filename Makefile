...
./bin/main.exe : ./src/main.cpp ./bin/Shader.o ./bin/SquareRender.o ./bin/Camera.o ./bin/FlappyBird.o
	g++ ./src/main.cpp ./dep/glad/src/glad.c ./bin/Shader.o ./bin/SquareRender.o ./bin/Camera.o ./bin/FlappyBird.o -o ./bin/main.exe -I./dep/glad/include -lglfw -ldl
